        ...
        const attachItemEvents = (item) => {
            ...
            if (dragHandle instanceof HTMLElement) {
                ...
                dragHandle.addEventListener("pointerdown", (event) => {
                    ...
                    dragHandle.classList.add("is-hold-ready");
                    ...
                    sortingState.holdTimerId = window.setTimeout(() => {
                        if (!sortingState || sortingState.pointerId !== event.pointerId || sortingState.item !== item) {
                            return;
                        }

                        activatePointerSorting(sortingState, event.clientY);
                    }, 180);
                });
