(function () {
    ...
    const qrScannerTuningVersion = "QR iOS v20260513.1";
    ...
    const getQrScannerProfile = () => {
        ...
        return {
            ...
            videoWidth: isApple ? 2560 : 1920,
            videoHeight: isApple ? 1440 : 1080,
            zoom: isApple ? 1.35 : 1.9
        };
    };
