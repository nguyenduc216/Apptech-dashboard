        ...
        var document = new XDocument(
            new XElement(MainNs + "styleSheet",
                ...
                new XElement(MainNs + "borders",
                    ...
                    new XElement(MainNs + "border",
                        new XElement(MainNs + "left", new XAttribute("style", "medium"), new XElement(MainNs + "color", new XAttribute("rgb", "FF4B5F5A"))),
                        new XElement(MainNs + "right", new XAttribute("style", "medium"), new XElement(MainNs + "color", new XAttribute("rgb", "FF4B5F5A"))),
                        new XElement(MainNs + "top", new XAttribute("style", "medium"), new XElement(MainNs + "color", new XAttribute("rgb", "FF4B5F5A"))),
                        new XElement(MainNs + "bottom", new XAttribute("style", "medium"), new XElement(MainNs + "color", new XAttribute("rgb", "FF4B5F5A"))),
                        new XElement(MainNs + "diagonal")),
                    new XElement(MainNs + "border",
                        new XElement(MainNs + "left", new XAttribute("style", "thin"), new XElement(MainNs + "color", new XAttribute("rgb", "FF6B7C78"))),
                        new XElement(MainNs + "right", new XAttribute("style", "thin"), new XElement(MainNs + "color", new XAttribute("rgb", "FF6B7C78"))),
                        new XElement(MainNs + "top", new XAttribute("style", "thin"), new XElement(MainNs + "color", new XAttribute("rgb", "FF6B7C78"))),
                        new XElement(MainNs + "bottom", new XAttribute("style", "thin"), new XElement(MainNs + "color", new XAttribute("rgb", "FF6B7C78"))),
                        new XElement(MainNs + "diagonal"))),
