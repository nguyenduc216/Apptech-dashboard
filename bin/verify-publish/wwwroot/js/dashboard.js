(function () {
    ...
    (() => {
        ...
        const statusNode = root?.querySelector("[data-xuat-kho-qr-status] span");
        ...
        const updateEmptyState = () => {
            emptyState?.classList.toggle("is-hidden", getRows().length > 0);
        };
        ...
        const fillRow = (row, item) => {
            ...
            setText(row, "[data-detail-display-qr]", item.qrCode);
